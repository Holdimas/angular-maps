(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('bingmaps'), require('async'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('angular-maps-v9', ['exports', '@angular/core', '@angular/common', 'bingmaps', 'async', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-maps-v9'] = {}, global.ng.core, global.ng.common, null, global.async, global.rxjs));
}(this, (function (exports, core, common, bingmaps, async, rxjs) { 'use strict';
    ...
    })(exports.MarkerTypeId || (exports.MarkerTypeId = {}));
    ...
    var Marker = /** @class */ (function () {
        ...
        Marker.CreateMarker = function (iconInfo) {
            switch (iconInfo.markerType) {
                case exports.MarkerTypeId.CanvasMarker: return Marker.CreateCanvasMarker(iconInfo);
                case exports.MarkerTypeId.DynamicCircleMarker: return Marker.CreateDynamicCircleMarker(iconInfo);
                case exports.MarkerTypeId.FontMarker: return Marker.CreateFontBasedMarker(iconInfo);
                case exports.MarkerTypeId.RotatedImageMarker: return Marker.CreateRotatedImageMarker(iconInfo);
                case exports.MarkerTypeId.RoundedImageMarker: return Marker.CreateRoundedImageMarker(iconInfo);
                case exports.MarkerTypeId.ScaledImageMarker: return Marker.CreateScaledImageMarker(iconInfo);
                case exports.MarkerTypeId.Custom: throw Error('Custom Marker Creators are not currently supported.');
            }
         ...
         * @memberof Marker
         */
        Marker.GetImageForMarker = function (icon) {
            if (icon == null || icon === '') {
                return null;
            }
            var img = null;
         ...
         * @memberof Marker
         */
        Marker.CreateDynamicCircleMarker = function (iconInfo) {
            if (document == null) {
    ...
    var Polyline = /** @class */ (function () {
         ...
         * @method
         */
        Polyline.GetPolylineCentroid = function (path) {
            var c = { latitude: 0, longitude: 0 };
            var off = path[0];
            if (off != null) {
                var twicearea = 0;
         ...
         * @protected
         */
        Polyline.prototype.GetBoundingCenter = function () {
            var c = { latitude: 0, longitude: 0 };
            var x1 = 90, x2 = -90, y1 = 180, y2 = -180;
         ...
         * @protected
         */
        Polyline.prototype.GetPolylineCentroid = function () {
            var path = this.GetPath();
    ...
    ***************************************************************************** */
    ...
    var SpiderClusterMarker = /** @class */ (function (_super) {
    ...
    })(exports.ClusterPlacementMode || (exports.ClusterPlacementMode = {}));
    ...
    })(exports.ClusterClickAction || (exports.ClusterClickAction = {}));
    ...
    var CanvasOverlay = /** @class */ (function () {
        ...
        Object.defineProperty(CanvasOverlay.prototype, "CanvasReady", {
             ...
             */
            get: function () { return this._canvasReady; },
            enumerable: false,
            configurable: true
        });
        ///
         ...
         */
        CanvasOverlay.prototype.Delete = function () {
            this.SetMap(null);
        };
        /**
         ...
         * @method
         */
        CanvasOverlay.prototype.Redraw = function (clear) {
         ...
         * @protected
         */
        CanvasOverlay.prototype.UpdatePosition = function (x, y, w, h) {
            // Update CSS position.
    ...
    var BingLayer = /** @class */ (function () {
         ...
         * @memberof BingLayer
         */
        BingLayer.prototype.AddEntities = function (entities) {
            var _this = this;
            //
    ...
    var BingConversions = /** @class */ (function () {
        ...
        BingConversions.TranslateClusterOptions = function (options) {
            ...
            Object.keys(options)
                ...
                if (k === 'placementMode') {
                    if (options.placementMode === exports.ClusterPlacementMode.FirstPin) {
        ...
        BingConversions.TranslateLoadOptions = function (options) {
            ...
            Object.keys(options)
                ...
                if (k === 'center') {
                    ...
                    if (options.mapTypeId === exports.MapTypeId.hybrid) {
                        o.mapTypeId = Microsoft.Maps.MapTypeId.aerial;
                        o.labelOverlay = Microsoft.Maps.LabelOverlay.visible;
                    }
                    else if (options.mapTypeId === exports.MapTypeId.aerial) {
                        o.mapTypeId = Microsoft.Maps.MapTypeId.aerial;
                        o.labelOverlay = Microsoft.Maps.LabelOverlay.hidden;
                    }
                    else {
                        o.mapTypeId = Microsoft.Maps.MapTypeId[exports.MapTypeId[options.mapTypeId]];
                    }
                }
                else if (k === 'bounds') {
     ...
     * @export
     */
    var BingClusterLayer = /** @class */ (function () {
        ///
        /// Constructor
        ///
        /**
         ...
         * @memberof BingClusterLayer
         */
        BingClusterLayer.prototype.AddEntities = function (entities) {
            var _a, _b;
            var _this = this;
            if (entities != null && Array.isArray(entities) && entities.length !== 0) {
     ...
     * @export
     */
    var BingInfoWindow = /** @class */ (function () {
        /**
    ...
    var Extender = /** @class */ (function () {
        ...
        Extender.prototype.Extend = function (newObj) {
        ...
        Extender.prototype.Set = function (property, newObj, obj) {
        ...
        Extender.prototype.Map = function (property, newProperty) {
     ...
     * @export
     */
    var BingMapLabel = /** @class */ (function (_super) {
     ...
     * @export
     */
    var BingPolygon = /** @class */ (function (_super) {
     ...
     * @export
     */
    var BingPolyline = /** @class */ (function (_super) {
     ...
     * @export
     */
    var BingCanvasOverlay = /** @class */ (function (_super) {
         ...
         * @memberof BingCanvasOverlay
         */
        BingCanvasOverlay.prototype.GetCoordinatesFromClick = function (e) {
         ...
         * @method
         */
        BingCanvasOverlay.prototype.GetMap = function () {
            return this.getMap();
        };
        /**
         ...
         * @method
         */
        BingCanvasOverlay.prototype.GetToolTipOverlay = function () {
            var o = {
                align: 'left',
                offset: new Microsoft.Maps.Point(0, 25),
                backgroundColor: 'bisque',
         ...
         * @memberof BingCanvasOverlay
         */
        BingCanvasOverlay.prototype.OnLoad = function () {
            var _this = this;
            var map = this.getMap();
         ...
         * @method
         */
        BingCanvasOverlay.prototype.SetMap = function (map) {
            var m = this.GetMap();
            if (map === m) {
                return;
            }
         ...
         * @method
         */
        BingCanvasOverlay.prototype.SetCanvasElement = function (el) {
         ...
         * @protected
         */
        BingCanvasOverlay.prototype.RemoveEventHandlers = function () {
         ...
         * @protected
         */
        BingCanvasOverlay.prototype.Resize = function () {
            var map = this.getMap();
            // Clear canvas by updating dimensions. This also ensures canvas stays the same size as the map.
         ...
         * @protected
         */
        BingCanvasOverlay.prototype.UpdateCanvas = function () {
            var map = this.getMap();
    ...
    var GoogleConversions = /** @class */ (function () {
        ...
        GoogleConversions.TranslateMapTypeId = function (mapTypeId) {
            switch (mapTypeId) {
                case exports.MapTypeId.road: return MapTypeId[MapTypeId.roadmap];
                case exports.MapTypeId.grayscale: return MapTypeId[MapTypeId.terrain];
                case exports.MapTypeId.hybrid: return MapTypeId[MapTypeId.hybrid];
                case exports.MapTypeId.ordnanceSurvey: return MapTypeId[MapTypeId.terrain];
                default: return MapTypeId[MapTypeId.satellite];
            }
        };
        /**
     ...
     * @export
     */
    var GoogleInfoWindow = /** @class */ (function () {
        ///
        /// constructor
        ///
        /**
     ...
     * @export
     */
    var GoogleMarker = /** @class */ (function () {
        ///
        /// Constructors
        ///
        /**
     ...
     * @export
     */
    var GoogleMapLabel = /** @class */ (function (_super) {
     ...
     * @export
     */
    var GooglePolygon = /** @class */ (function (_super) {
     ...
     * @export
     */
    var GooglePolyline = /** @class */ (function (_super) {
     ...
     * @export
     */
    var GoogleCanvasOverlay = /** @class */ (function (_super) {
         ...
         * @memberof GoogleCanvasOverlay
         */
        GoogleCanvasOverlay.prototype.GetCoordinatesFromClick = function (e) {
            if (!e) {
                return null;
            }
            if (!e.latLng) {
         ...
         * @method
         */
        GoogleCanvasOverlay.prototype.GetMap = function () {
            return this.getMap();
        };
        /**
         * Returns a MapLabel instance for the current platform that can be used as a tooltip.
         ...
         * @method
         */
        GoogleCanvasOverlay.prototype.GetToolTipOverlay = function () {
            var o = {
                align: 'left',
                offset: new google.maps.Point(0, 25),
                backgroundColor: 'bisque',
         ...
         * @memberof GoogleCanvasOverlay
         */
        GoogleCanvasOverlay.prototype.OnAdd = function () {
         ...
         * @method
         */
        GoogleCanvasOverlay.prototype.OnDraw = function () {
         ...
         * @memberof GoogleCanvasOverlay
         */
        GoogleCanvasOverlay.prototype.OnLoad = function () {
            var _this = this;
            var isStreetView = false;
            var map = this.getMap();
            // Get the current map view information.
         ...
         * @memberof GoogleCanvasOverlay
         */
        GoogleCanvasOverlay.prototype.SetMap = function (map) {
            this.setMap(map);
        };
        ///
        /// Protected methods
         ...
         * @method
         */
        GoogleCanvasOverlay.prototype.SetCanvasElement = function (el) {
            var panes = this.getPanes();
            if (panes) {
                if (el != null) {
         ...
         * @protected
         */
        GoogleCanvasOverlay.prototype.RemoveEventHandlers = function () {
            // Remove all event handlers from the map.
         ...
         * @protected
         */
        GoogleCanvasOverlay.prototype.Resize = function () {
            var map = this.getMap();
            // Clear canvas by updating dimensions. This also ensures canvas stays the same size as the map.
            var el = map.getDiv();
         ...
         * @protected
         */
        GoogleCanvasOverlay.prototype.UpdateCanvas = function () {
            var map = this.getMap();
            // Only render the canvas if it isn't in streetside mode.
            if (true) {
                this._canvas.style.display = '';
    ...
    var MapService = /** @class */ (function () {
         ...
         * @memberof MapService
         */
        MapService.GetRandonLocations = function (count, bounds) {
            var a = [];
        ...
        MapComponent.prototype.InitMapInstance = function (el) {
            ...
            this._zone.runOutsideAngular(function () {
                ...
                if (_this._options.mapTypeId == null) {
                    _this._options.mapTypeId = exports.MapTypeId.hybrid;
                }
                if (_this._box != null) {
    ...
    var ClusterLayerDirective = /** @class */ (function (_super) {
        ...
        function ClusterLayerDirective(_layerService, _containerRef) {
            ...
            _this._clusterPlacementMode = exports.ClusterPlacementMode.MeanValue;
            _this._clusterClickAction = exports.ClusterClickAction.ZoomIntoCluster;
    ...
    var MapMarkerLayerDirective = /** @class */ (function () {
        ...
        function MapMarkerLayerDirective(_markerService, _layerService, _clusterService, _mapService, _zone) {
             ...
             * @memberof MapMarkerLayerDirective
             */
            this.ClusterClickAction = exports.ClusterClickAction.ZoomIntoCluster;
            /**
             * Gets or sets the cluster placement mode. {@link ClusterPlacementMode}
             *
             * @memberof MapMarkerLayerDirective
             */
            this.ClusterPlacementMode = exports.ClusterPlacementMode.MeanValue;
            /**
        ...
        Object.defineProperty(MapMarkerLayerDirective.prototype, "MarkerOptions", {
             ...
             * @memberof MapMarkerLayerDirective
             */
            get: function () { return this._markers; },
            set: function (val) {
                var _a, _b;
                if (this._streaming) {
        ...
        Object.defineProperty(MapMarkerLayerDirective.prototype, "TreatNewMarkerOptionsAsStream", {
             ...
             * @memberof MapMarkerLayerDirective
             */
            get: function () { return this._streaming; },
            set: function (val) { this._streaming = val; },
            enumerable: false,
            configurable: true
        });
         ...
         * @memberof MapMarkerLayerDirective
         */
        MapMarkerLayerDirective.prototype.LocationToPixel = function (loc) {
         ...
         * @memberof MapMarkerLayerDirective
         */
        MapMarkerLayerDirective.prototype.ngAfterContentInit = function () {
            var _this = this;
            var layerOptions = {
                id: this._id
            };
         ...
         * @memberof MapMarkerLayerDirective
         */
        MapMarkerLayerDirective.prototype.ngOnDestroy = function () {
         ...
         * @memberof MapMarkerLayerDirective
         */
        MapMarkerLayerDirective.prototype.ngOnChanges = function (changes) {
            var _this = this;
            ...
            if (changes['ClusterClickAction'] && !changes['ClusterClickAction'].firstChange && 'StopClustering' in this._service) {
                o.zoomOnClick = this.ClusterClickAction === exports.ClusterClickAction.ZoomIntoCluster;
                shouldSetOptions = true;
            }
         ...
         * @memberof MapMarkerLayerDirective
         */
        MapMarkerLayerDirective.prototype.toString = function () { return 'MapMarkerLayer-' + this._id.toString(); };
        ///
        /// Private methods
        ///
        /**
         ...
         * @memberof MapMarkerLayerDirective
         */
        MapMarkerLayerDirective.prototype.AddEventListeners = function (m) {
            var _this = this;
         ...
         * @method
         */
        MapMarkerLayerDirective.prototype.UpdateMarkers = function () {
            var _this = this;
    ...
    var MapPolygonLayerDirective = /** @class */ (function () {
        ...
        Object.defineProperty(MapPolygonLayerDirective.prototype, "PolygonOptions", {
             ...
             * @memberof MapPolygonLayerDirective
             */
            get: function () { return this._polygons; },
            set: function (val) {
                var _a, _b;
                if (this._streaming) {
         ...
         * @memberof MapPolygonLayerDirective
         */
        MapPolygonLayerDirective.prototype.ngAfterContentInit = function () {
            var _this = this;
            var layerOptions = {
                id: this._id
            };
         ...
         * @memberof MapPolygonLayerDirective
         */
        MapPolygonLayerDirective.prototype.ngOnDestroy = function () {
         ...
         * @memberof MapPolygonLayerDirective
         */
        MapPolygonLayerDirective.prototype.ngOnChanges = function (changes) {
            var _this = this;
         ...
         * @memberof MapPolygonLayerDirective
         */
        MapPolygonLayerDirective.prototype.toString = function () { return 'MapPolygonLayer-' + this._id.toString(); };
        ///
        /// Private methods
        ///
        /**
         ...
         * @memberof MapPolygonLayerDirective
         */
        MapPolygonLayerDirective.prototype.AddEventListeners = function (p) {
            var _this = this;
            var handlers = [
         ...
         * @memberof MapPolygonLayerDirective
         */
        MapPolygonLayerDirective.prototype.DrawLabels = function (el) {
            var _this = this;
            if (this.ShowLabels) {
         ...
         */
        MapPolygonLayerDirective.prototype.DrawText = function (ctx, loc, text) {
         ...
         * @memberof MapPolygonLayerDirective
         */
        MapPolygonLayerDirective.prototype.ManageTooltip = function (show) {
            var _this = this;
         ...
         * @method
         */
        MapPolygonLayerDirective.prototype.UpdatePolygons = function () {
            var _this = this;
            if (this._layerPromise == null) {
                return;
            }
    ...
    var MapPolylineLayerDirective = /** @class */ (function () {
        ...
        Object.defineProperty(MapPolylineLayerDirective.prototype, "PolylineOptions", {
             ...
             * @memberof MapPolylineLayerDirective
             */
            get: function () { return this._polylines; },
            set: function (val) {
                var _a, _b;
                if (this._streaming) {
         ...
         * @memberof MapPolylineLayerDirective
         */
        MapPolylineLayerDirective.prototype.ngAfterContentInit = function () {
            var _this = this;
            var layerOptions = {
                id: this._id
            };
         ...
         * @memberof MapPolylineLayerDirective
         */
        MapPolylineLayerDirective.prototype.ngOnDestroy = function () {
            this._tooltipSubscriptions.forEach(function (s) { return s.unsubscribe(); });
            this._layerPromise.then(function (l) {
                l.Delete();
            });
         ...
         * @memberof MapPolylineLayerDirective
         */
        MapPolylineLayerDirective.prototype.ngOnChanges = function (changes) {
            var _this = this;
         ...
         * @memberof MapPolylineLayerDirective
         */
        MapPolylineLayerDirective.prototype.toString = function () { return 'MapPolylineLayer-' + this._id.toString(); };
        ///
        /// Private methods
        ///
        /**
         ...
         * @memberof MapPolylineLayerDirective
         */
        MapPolylineLayerDirective.prototype.AddEventListeners = function (p) {
            var _this = this;
            var handlers = [
         ...
         * @memberof MapPolylineLayerDirective
         */
        MapPolylineLayerDirective.prototype.DrawLabels = function (el) {
            var _this = this;
            if (this.ShowLabels) {
                this._mapService.GetZoom().then(function (z) {
                    if (_this.LabelMinZoom <= z && _this.LabelMaxZoom >= z) {
         ...
         * @param text - Text to draw.
         */
        MapPolylineLayerDirective.prototype.DrawText = function (ctx, loc, text) {
            var lo = this.LabelOptions;
            if (lo == null && this._tooltip) {
                lo = this._tooltip.DefaultLabelStyle;
            }
         ...
         * @memberof MapPolygonLayerDirective
         */
        MapPolylineLayerDirective.prototype.ManageTooltip = function (show) {
            var _this = this;
            if (show && this._canvas) {
                // add tooltip subscriptions
                this._tooltip.Set('hidden', true);
         ...
         * @method
         */
        MapPolylineLayerDirective.prototype.UpdatePolylines = function () {
            var _this = this;
            if (this._layerPromise == null) {
                return;
            }
    ...
    var BingMarkerService = /** @class */ (function () {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.AddMarker = function (marker) {
            var o = {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.CreateEventObservable = function (eventName, marker) {
            var _this = this;
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.DeleteMarker = function (marker) {
            var _this = this;
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.GetCoordinatesFromClick = function (e) {
            if (!e) {
                return null;
            }
            if (!e.primitive) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.GetNativeMarker = function (marker) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.GetPixelsFromClick = function (e) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.LocationToPoint = function (target) {
            var _this = this;
            if (target == null) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.UpdateAnchor = function (marker) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.UpdateDraggable = function (marker) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.UpdateIcon = function (marker) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.UpdateLabel = function (marker) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.UpdateMarkerPosition = function (marker) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.UpdateTitle = function (marker) {
         ...
         * @memberof BingMarkerService
         */
        BingMarkerService.prototype.UpdateVisible = function (marker) {
    ...
    var BingMapService = /** @class */ (function () {
         ...
         * @memberof BingMapService
         */
        BingMapService.prototype.CreateCanvasOverlay = function (drawCallback) {
         ...
         * @memberof BingMapService
         */
        BingMapService.prototype.GetDrawingTools = function (useSharedInstance) {
            var _this = this;
         ...
         * @memberof BingMapService
         */
        BingMapService.prototype.LoadModule = function (moduleName, callback) {
            var _this = this;
         ...
         * @memberof BingMapService
         */
        BingMapService.prototype.LoadModuleInstance = function (moduleName, useSharedInstance) {
            var _this = this;
            if (useSharedInstance === void 0) { useSharedInstance = true; }
         ...
         * @memberof BingMapService
         */
        BingMapService.prototype.LocationsToPoints = function (locs) {
            return this._map.then(function (m) {
     ...
     * @abstract
     */
    var BingLayerBase = /** @class */ (function () {
        ///
        /// Constructor
        ///
        /**
         ...
         * @memberof BingLayerBase
         */
        BingLayerBase.prototype.CreateMarkers = function (options, markerIcon) {
         ...
         * @memberof BingLayerBase
         */
        BingLayerBase.prototype.DeleteLayer = function (layer) {
            var _this = this;
         ...
         * @memberof BingLayerBase
         */
        BingLayerBase.prototype.GetNativeLayer = function (layer) {
            var p = null;
    ...
    var BingLayerService = /** @class */ (function (_super) {
        ...
        BingLayerService.prototype.CreatePolygon = function (layer, options) {
            ...
            return p.then(function (l) {
                ...
                var o = BingConversions.TranslatePolygonOptions(options);
                var poly = new Microsoft.Maps.Polygon(locs, o);
                var polygon = new BingPolygon(poly, _this._mapService, l.NativePrimitve);
                if (options.metadata) {
         ...
         * @memberof BingLayerService
         */
        BingLayerService.prototype.CreatePolygons = function (layer, options) {
            var _this = this;
            var p = this.GetLayerById(layer);
            if (p == null) {
                throw (new Error("Layer with id " + layer + " not found in Layer Map"));
         ...
         * @memberof BingLayerService
         */
        BingLayerService.prototype.CreatePolylines = function (layer, options) {
            var _this = this;
            var p = this.GetLayerById(layer);
            if (p == null) {
                throw (new Error("Layer with id " + layer + " not found in Layer Map"));
    ...
    var BingClusterService = /** @class */ (function (_super) {
         ...
         * @memberof BingClusterService
         */
        BingClusterService.prototype.CreatePolygons = function (layer, options) {
            throw (new Error('Polygons are not supported in clustering layers. You can only use markers.'));
        };
        /**
         * Adds a polyline to the layer.
         ...
         * @memberof BingClusterService
         */
        BingClusterService.prototype.CreatePolylines = function (layer, options) {
            throw (new Error('Polylines are not supported in clustering layers. You can only use markers.'));
        };
        /**
         * Start to actually cluster the entities in a cluster layer. This method should be called after the initial set of entities
        ...
        BingClusterService.prototype.CreateClusterPushPin = function (cluster, layer) {
            ...
            this._layers.get(layer.Id).then(function (l) {
                ...
                if (layer.ClusterClickAction === exports.ClusterClickAction.ZoomIntoCluster) {
                    Microsoft.Maps.Events.addHandler(cluster, 'click', function (e) { return _this.ZoomIntoCluster(e); });
                }
                if (layer.ClusterClickAction === exports.ClusterClickAction.Spider) {
        ...
        BingClusterService.prototype.CreateCustomClusterPushPin = function (cluster, layer) {
            ...
            this._layers.get(layer.Id).then(function (l) {
                ...
                var iconInfo = { markerType: exports.MarkerTypeId.None };
                var o = {};
     ...
     * @abstract
     */
    var GoogleLayerBase = /** @class */ (function () {
        ///
        /// Constructor
        ///
        /**
         ...
         * @memberof GoogleLayerBase
         */
        GoogleLayerBase.prototype.DeleteLayer = function (layer) {
            var _this = this;
            var l = this._layers.get(layer.Id);
            if (l == null) {
                return Promise.resolve();
         ...
         * @memberof GoogleLayerBase
         */
        GoogleLayerBase.prototype.GetNativeLayer = function (layer) {
            var p = null;
            if (typeof (layer) === 'number') {
                p = this._layers.get(layer);
            }
         ...
         * @memberof GoogleLayerBase
         */
        GoogleLayerBase.prototype.CreateMarkers = function (options, markerIcon) {
    ...
    var GoogleClusterService = /** @class */ (function (_super) {
        ...
        GoogleClusterService.prototype.AddLayer = function (layer) {
            ...
            var options = {
                ...
                visible: layer.Visible,
                clusteringEnabled: layer.ClusteringEnabled,
                zoomOnClick: layer.ClusterClickAction === exports.ClusterClickAction.ZoomIntoCluster
            };
            if (layer.GridSize) {
                options.gridSize = layer.GridSize;
            }
            ...
            if (layer.UseDynamicSizeMarkers) {
                ...
                options.styles = [{
                        ...
                        iconInfo: {
                            markerType: exports.MarkerTypeId.FontMarker,
            ...
            var dynamicClusterCallback = function (markers, numStyles, clusterer) {
                ...
                var iconInfo = {
                    markerType: exports.MarkerTypeId.None
                };
         ...
         * @memberof GoogleClusterService
         */
        GoogleClusterService.prototype.CreatePolygons = function (layer, options) {
            throw (new Error('Polygons are not supported in clustering layers. You can only use markers.'));
        };
        /**
         * Adds a polyline to the layer.
         ...
         * @memberof GoogleClusterService
         */
        GoogleClusterService.prototype.CreatePolylines = function (layer, options) {
            throw (new Error('Polylines are not supported in clustering layers. You can only use markers.'));
        };
     ...
     * @export
     */
    var GoogleLayer = /** @class */ (function () {
        ///
        /// Constructor
        ///
        /**
         ...
         * @memberof GoogleLayer
         */
        GoogleLayer.prototype.AddListener = function (eventType, fn) {
         ...
         * @memberof GoogleLAyer
         */
        GoogleLayer.prototype.AddEntity = function (entity) {
            if (entity.NativePrimitve) {
         ...
         * @memberof GoogleLAyer
         */
        GoogleLayer.prototype.AddEntities = function (entities) {
            var _a;
            var _this = this;
            if (entities != null && Array.isArray(entities) && entities.length !== 0) {
         ...
         * @memberof GoogleLayer
         */
        GoogleLayer.prototype.Delete = function () {
         ...
         * @memberof GoogleLayer
         */
        GoogleLayer.prototype.GetOptions = function () {
            var options = {
                id: this._id
            };
            return options;
         ...
         * @memberof GoogleLayer
         */
        GoogleLayer.prototype.GetVisible = function () {
         ...
         * @memberof GoogleLayer
         */
        GoogleLayer.prototype.RemoveEntity = function (entity) {
            if (entity.NativePrimitve) {
         ...
         * @memberof GoogleLayer
         */
        GoogleLayer.prototype.SetEntities = function (entities) {
            this.Delete();
            this.AddEntities(entities);
        };
        /**
         ...
         * @memberof GoogleLayer
         */
        GoogleLayer.prototype.SetOptions = function (options) {
            this._id = options.id;
        };
        /**
         * Toggles the cluster layer visibility.
         ...
         */
        GoogleLayer.prototype.SetVisible = function (visible) {
    ...
    var GoogleLayerService = /** @class */ (function (_super) {
         ...
         * @memberof GoogleLayerService
         */
        GoogleLayerService.prototype.CreatePolygons = function (layer, options) {
            //
        ...
        GoogleLayerService.prototype.CreatePolyline = function (layer, options) {
            ...
            Promise.all([p, l]).then(function (x) {
                var e_1, _a;
                var p1 = Array.isArray(x[0]) ? x[0] : [x[0]];
                try {
         ...
         * @memberof GoogleLayerService
         */
        GoogleLayerService.prototype.CreatePolylines = function (layer, options) {
            var p = this.GetLayerById(layer);
            if (p == null) {
                throw (new Error("Layer with id " + layer + " not found in Layer Map"));
            }
     ...
     * @export
     */
    var GoogleMarkerClusterer = /** @class */ (function () {
        ///
        /// Constructor
        ///
        /**
         ...
         * @memberof GoogleMarkerClusterer
         */
        GoogleMarkerClusterer.prototype.AddEntities = function (entities) {
            var _a, _b;
            var _this = this;
            if (entities != null && Array.isArray(entities) && entities.length !== 0) {
                var e = entities.map(function (p) {
        ...
        GoogleMarkerClusterer.prototype.GetOptions = function () {
            var options = {
                ...
                placementMode: this._layer.isAverageCenter() ? exports.ClusterPlacementMode.MeanValue : exports.ClusterPlacementMode.FirstPin,
    ...
    var GoogleMapService = /** @class */ (function () {
         ...
         * @memberof GoogleMapService
         */
        GoogleMapService.prototype.CreateCanvasOverlay = function (drawCallback) {
            return this._map.then(function (map) {
        ...
        GoogleMapService.prototype.CreateMap = function (el, mapOptions) {
            ...
            return this._loader.Load().then(function () {
                ...
                if (!mapOptions.mapTypeId == null) {
                    mapOptions.mapTypeId = exports.MapTypeId.hybrid;
                }
                if (_this._mapInstance != null) {
                    _this.DisposeMap();
                }
         ...
         * @memberof BingMapService
         */
        GoogleMapService.prototype.LocationsToPoints = function (locs) {
            return this._map.then(function (m) {
                var crossesDateLine = false;
                var p = m.getProjection();
                var s = Math.pow(2, m.getZoom());
    ...
    var MapModule = /** @class */ (function () {
        ...
        MapModule.forRoot = function (mapServiceFactory, loader) {
            return {
                ngModule: MapModule,
                providers: [
        ...
        MapModule.forRootBing = function () {
            return {
                ngModule: MapModule,
                providers: [
                    { provide: MapServiceFactory, deps: [MapAPILoader, core.NgZone], useFactory: BingMapServiceFactoryFactory },
        ...
        MapModule.forRootGoogle = function () {
            return {
                ngModule: MapModule,
                providers: [
...
//# sourceMappingURL=angular-maps-v9.umd.js.map
